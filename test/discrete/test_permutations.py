...
from discrete.permutation import generate_permutations_string
...
class TestPermutations(unittest.TestCase):
    ...
    def test_permutations_basic(self):
        basic_string = "abcdef"
        actual_perms = set(generate_permutations_string(basic_string))
    ...
    def test_permutations_empty(self):
        empty_string = " "
        actual_perms = set(generate_permutations_string(empty_string))
